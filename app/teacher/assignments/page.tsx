  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 space-y-8">
      <PageHeader
        tag="Faculty Portal"
        title="Assignments"
        description="Create, distribute, and manage assignments for your assigned subjects and classes."
      />
      ...
      <EmptyState
        ...
        title="Assignments"
        message="Create and track assignments for your classes. Assignments are enabled only for subjects assigned to you."
      />
    </div>
  );
}
