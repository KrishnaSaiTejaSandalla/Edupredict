    ...
    <main className="min-h-screen bg-background text-foreground p-4 sm:p-6 lg:p-8 space-y-8">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <a
            href="/admin/classes"
            className="inline-flex items-center gap-1.5 text-xs font-semibold uppercase tracking-widest text-muted-foreground hover:text-cyan-500 transition mb-3"
          >
          ...
          <h1 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">Class {cls.name}</h1>
      ...
      <div className="max-w-2xl space-y-6">
        <section className="rounded-2xl border border-border bg-card p-6 shadow-md">
          <h2 className="text-sm font-semibold text-foreground uppercase tracking-wider mb-5">Edit Class</h2>
          <ClassForm action={updateClass} initial={initial} submitLabel="Update Class" />
        </section>

        <section className="rounded-2xl border border-red-500/20 bg-red-950/10 p-6 shadow-md">
