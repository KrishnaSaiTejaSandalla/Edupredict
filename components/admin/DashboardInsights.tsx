...
function InsightItem({
  ...
  return (
    <div className="flex items-center gap-4 rounded-xl border border-subtle bg-hover/20 p-4 hover:bg-hover transition duration-200">
...
export default function DashboardInsights({
  ...
  const insights = [
    ...
    },
    {
      ...
      color: averageAttendance >= 80 ? "bg-emerald-500/15 text-emerald-600 dark:text-emerald-400" : averageAttendance >= 70 ? "bg-amber-500/15 text-amber-600 dark:text-amber-400" : "bg-rose-500/15 text-rose-500 dark:text-rose-400",
      icon: (
        <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    },
    {
      ...
      color: passRate >= 80 ? "bg-cyan-500/15 text-cyan-600 dark:text-cyan-400" : passRate >= 60 ? "bg-amber-500/15 text-amber-600 dark:text-amber-400" : "bg-rose-500/15 text-rose-500 dark:text-rose-400",
      icon: (
        <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    },
    {
      ...
      color: atRiskCount === 0 ? "bg-emerald-500/15 text-emerald-600 dark:text-emerald-400" : atRiskCount <= 3 ? "bg-amber-500/15 text-amber-600 dark:text-amber-400" : "bg-rose-500/15 text-rose-500 dark:text-rose-400",
      icon: (
        <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2">
