...
export default async function StudentSettingsPage() {
  ...
  return (
    <main className="min-h-screen bg-base p-4 sm:p-6 lg:p-8 text-primary transition-colors duration-200">
      <SettingsClient
        user={dbUser ? {
          id: dbUser.id, name: dbUser.name, email: dbUser.email, schoolId: dbUser.schoolId,
          bio: dbUser.bio, profileImageUrl: dbUser.profileImageUrl, designation: dbUser.designation,
          phoneNumber: dbUser.phoneNumber, notificationPreferences: dbUser.notificationPreferences,
          appearancePreferences: dbUser.appearancePreferences
        } : {
          id: authUser.id, name: authUser.name, email: authUser.email || "", schoolId: null,
          bio: null, profileImageUrl: null, designation: null, phoneNumber: null,
          notificationPreferences: null, appearancePreferences: null
        }}
        school={school}
