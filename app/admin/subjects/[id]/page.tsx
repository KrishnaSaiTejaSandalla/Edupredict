    ...
    <main className="min-h-screen bg-background text-foreground p-4 sm:p-6 lg:p-8 space-y-8 transition-colors duration-200">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <a
            href="/admin/subjects"
            className="inline-flex items-center gap-1.5 text-xs font-semibold uppercase tracking-widest text-muted-foreground hover:text-cyan-400 transition mb-3"
          >
          ...
          <h1 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">{subject.name}</h1>
      ...
      <div className="max-w-2xl space-y-6">
        <section className="rounded-2xl border border-border bg-card p-6 shadow-md transition-colors duration-200">
          <h2 className="text-sm font-semibold text-foreground uppercase tracking-wider mb-5">Edit Subject</h2>
          <SubjectForm action={updateSubject} initial={initial} submitLabel="Update Subject" />
        </section>

        <section className="rounded-2xl border border-red-500/20 bg-red-500/5 p-6 shadow-md transition-colors duration-200">
          <h2 className="text-sm font-semibold text-red-500 dark:text-red-400 uppercase tracking-wider mb-2">Danger Zone</h2>
