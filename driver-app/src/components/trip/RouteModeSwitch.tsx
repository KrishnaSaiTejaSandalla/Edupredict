...
interface RouteModeSwitchProps {
  isEveningMode: boolean;
  onToggle: (isEvening: boolean) => void;
}

export const RouteModeSwitch: React.FC<RouteModeSwitchProps> = ({
  isEveningMode,
  onToggle,
}) => {
  return (
    <StyledWrapper>
      <label className="theme-switch" title={isEveningMode ? 'Evening Drop Route' : 'Morning Pickup Route'}>
        <input
          type="checkbox"
...
const StyledWrapper = styled.div`
  ...
  .theme-switch__clouds {
    ...
    box-shadow: 0.937em 0.312em var(--clouds-color), -0.312em -0.312em var(--back-clouds-color),
      ...
      3.625em -0.062em var(--clouds-color), 2.625em 0em var(--back-clouds-color), 4.5em -0.312em var(--clouds-color),
...
export default RouteModeSwitch;
